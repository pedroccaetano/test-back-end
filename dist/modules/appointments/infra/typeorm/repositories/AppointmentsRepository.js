...
var ApointmentsRepository = /** @class */ (function () {
    function ApointmentsRepository() {
        this.ormRepository = typeorm_1.getRepository(Appointment_1.default);
    }
    ApointmentsRepository.prototype.findByDate = function (date) {
    ...
    ApointmentsRepository.prototype.findAllInMonthFromProvider = function (_a) {
        var provider_id = _a.provider_id, month = _a.month, year = _a.year;
        return __awaiter(this, void 0, void 0, function () {
            var parsedMoth, appointments;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        parsedMoth = String(month).padStart(2, '0');
                        return [4 /*yield*/, this.ormRepository.find({
                                where: {
                                    provider_id: provider_id,
                                    date: typeorm_1.Raw(function (dateFieldName) {
                                        return "to_char(" + dateFieldName + ", 'MM-YYYY) = '" + parsedMoth + "-" + year + "'";
                                    }),
                                },
                            })];
                    case 1:
    ...
    ApointmentsRepository.prototype.findAllInDayFromProvider = function (_a) {
        var provider_id = _a.provider_id, day = _a.day, month = _a.month, year = _a.year;
        return __awaiter(this, void 0, void 0, function () {
            var parsedDay, parsedMoth, appointments;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.ormRepository.find({
                                where: {
                                    provider_id: provider_id,
                                    date: typeorm_1.Raw(function (dateFieldName) {
                                        return "to_char(" + dateFieldName + ", 'DD-MM-YYYY) = '" + parsedDay + "-" + parsedMoth + "-" + year + "'";
                                    }),
                                },
                            })];
                    case 1:
    ...
    ApointmentsRepository.prototype.create = function (_a) {
    ...
    return ApointmentsRepository;
}());
exports.default = ApointmentsRepository;
