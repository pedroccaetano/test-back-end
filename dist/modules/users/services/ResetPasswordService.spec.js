...
describe('ResetPasswordService', function () {
  ...
  it('should not be able to reset the password with non-existing token', function () {
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              fakeUserTokensRepository.generate('non-existing-user'),
            ];
          case 1:
            token = _a.sent().token;
            return [
  ...
  it('should not be able to reset the password if passed more than 2 hours', function () {
    return __awaiter(void 0, void 0, void 0, function () {
      var user, token;
      return __generator(this, function (_a) {
        switch (_a.label) {
