...
var UpdateProfileService = /** @class */ (function () {
    function UpdateProfileService(usersRepository, hasProvider) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.hasProvider.compareHash(old_password, user.password)];
                    case 3:
                        ...
                        _b = user;
                        return [4 /*yield*/, this.hasProvider.generateHash(password)];
                    case 4:
                        _b.password = _c.sent();
                        _c.label = 5;
